...
[@cost-splitting](../concepts/CostSplitting/implement.md)
[@itinerary-planner](../concepts/ItineraryPlanner/implement.md)
[@password-auth](../concepts/PasswordAuth/implement.md)
[@polling](../concepts/Polling/implement.md)
[@trip-planner](../concepts/TripPlanner/implement.md)

Can you help me a write syncs to ensure users are authenticated when accessing these routes as control guards:
